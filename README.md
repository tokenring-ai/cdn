...
This schema accepts an empty configuration object or no configuration at all. Specific CDN provider implementations should define their own configuration schemas.
